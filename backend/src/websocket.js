 ...
 */
exports.findConnections = (coordinates, searchBusLineCode, searchBusLineName,user_id) => {
  return connections.filter(connection => {
    return connection.user_id !== user_id
    && calculateDistance(coordinates, connection.coordinates) < 10; //10 kilometers
...
exports.sendMessage = (to, message, data) => {
  console.log('sendMessageTo',to,message,data);
